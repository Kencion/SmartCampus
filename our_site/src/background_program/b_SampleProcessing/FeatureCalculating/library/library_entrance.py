...
class library_entrance1(FeatureCalculater):
    ...
    @MyLogger.myException
    def cluster(self):
        maxx,minn,cent=FeatureCalculater.cluster(self,featureName='library_entrance', clusters=4, sql="SELECT library_entrance FROM students WHERE library_entrance != 0")
