...
class subsidy_amount(FeatureCalculater.FeatureCalculater):
    ...
    @MyLogger.myException
    def cluster(self):
        maxx,minn,cent=FeatureCalculater.FeatureCalculater.cluster(self,featureName='subsidy_amount', clusters=4, sql="SELECT subsidy_amount FROM students WHERE subsidy_amount != 0")
