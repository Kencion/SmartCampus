...
class library_study_time(FeatureCalculater.FeatureCalculater):
    ...
    @MyLogger.myException
    def cluster(self):
        maxx,minn,cent=FeatureCalculater.FeatureCalculater.cluster(self,featureName='library_study_time', clusters=4, sql="SELECT library_study_time FROM students WHERE library_study_time != 0")
