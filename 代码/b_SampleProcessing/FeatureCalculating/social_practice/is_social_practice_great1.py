...
class is_social_practice_great1(FeatureCalculater):
    ...
    @MyLogger.myException
    def cluster(self):
        maxx,minn,cent=FeatureCalculater.cluster(self,featureName='is_social_practice_great', clusters=4, sql="SELECT is_social_practice_great FROM students WHERE is_social_practice_great != 0")
