...
class ClassFailingWarning():
    ...
    def __init__(self):
        ...
        from b_SampleProcessing.Dimension_Reduction import Pca_Learn
        from b_SampleProcessing.Dimension_Reduction import Pca_Test
        ...
        featureSelector.fit_transform(self.X_train)
        p=Pca_Test()
